...
## Overview
The ALANA Strategy & Infrastructure working group is concerned with researching, designing, and developing robust infrastructure around the project and our community to ensure its longevity, continuous decentralization, and circular economy (token engineering).
<br/>
<br/>

## Organizational Design
Originally, stellaachenbach (founder) created ALANA as a 3D avatar to give a face to the Web3 Revolution. As ALANA grew more popular among fellow designers and creators, stellaachenbach decided to utilize this attraction to evolve the once personal project into something more impactful. Since then, and with the support of many contributors and partners, it has transitioned from a very centralized project to a continuously decentralized one, run by various members of ALANA's community. 
To learn more about the project and how we are organized, we suggest the following:
- **[Take the Web3 LEARNER Journey](https://zealy.io/cw/thealanaproject):** A gamified learner journey that helps with gaining basic knowledge about Web3 and the ALANA Community.
...
<br/>
ALANA's Manifesto is the base NFT and symbolizes our collective values. It is also used to gain access to community channels and interactions (access criteria coming soon). For those who seek to join on a more serious basis, there are three different levels of memberships we have composed and voted on:
...
3. We had to establish and vote on an organizational structure that enabled fairness and equality based on contribution, not financial investment. As mentioned above, we did so by designing various tools that promote transparency and by meticulously defining stakeholder roles. 
...
This problem led us to discuss how contributions can be measured if contributed by different actors and for various tasks. How can we capture performance, impact, and growth from a single contribution and in comparison to others? Our proposed solution is called [“Contribution Calculator”](https://docs.google.com/spreadsheets/d/1gPvS1HQ1t0VuWf6FvHXqB0YE8vM0fwE4-R8ydY9eTSg/edit?usp=sharing) (ongoing work in progress), a tool that correlates the individual work input into points, which will be used to determine and calculate the amount of $ALANA token that a contributor can claim at the end of a season. As a consequence, we came to the conclusion that our token emission schedule needs to be KPI-based. On the demand side, the $ALANA token is influenced by the number of customers using or holding it.  
